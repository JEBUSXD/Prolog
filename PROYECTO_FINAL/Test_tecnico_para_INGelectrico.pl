...
/**************************Ventana principal con fondo, t�tulo y botones************************************/
a:- new(V, dialog('Cuestionario para un ingeniero electrico')),
    ...
    new(SubTitulo, label(subtitulo, 'Especialidad: Materiales de Distribuci�n El�ctrica')),
    new(Texto, label(info, 'Este cuestionario de preguntas fue logrado gracias a:')),
    new(Texto2, label(info2, 'ING. Electrico \nCristian Rosales Romao.\nEncargado de prescripci�n de materiales.\nEmpresa mercantil Le�n srl.\nEste test contiene 30 preguntas t�cnicas.')),
