...
preguntas([],Total) :-
    puntuacion(P),
    Porcentajefallo is Total-P, 
    Porcentaje is round((P * 100) / Total),                         %P=(17*100)/30,round(56.67) = 57
    format(atom(Resultado), 'Tu puntuacion fue: ~w% \n(fallos: ~w) \nPreguntas correctas:~w' , [Porcentaje, Porcentajefallo, P]),%el simbolo ~w se sustituye por Porcentaje
