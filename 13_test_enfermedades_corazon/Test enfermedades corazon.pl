%Autor.- Siria Barriga Villarroel /*tarea animoilosis*/
...
% ANQUILOSIS %  >>>>>>>>>>>>>>>>>Tarea 
diagnostico('       SEGUN EL TEST RELIZADO TIENE LOS SINTOMAS DE LA ENFERMEDAD DE ANQUILOSIS

              ¿Qué es la Anquilosis?

es una enfermedad inflamatoria crónica que puede afectar el corazón, pero no directamente la "anquilosis"      (rigidez o fusión) del corazón.
    
    PARA ESTAR SEGURO VISITE A UN ESPECIALISTA '):-anquilosis,!.
...
diagnostico('       SEGUN EL TEST RELIZADO TIENE LOS SINTOMAS DE LA ENFERMEDAD DE ANQUILOSIS
    ...
    es una enfermedad inflamatoria crónica que puede afectar el corazón, pero no directamente la "anquilosis"         (rigidez o fusión) del corazón. La SA, que afecta principalmente la columna vertebral, puede, en algunos        casos, causar problemas cardíacos como pericarditis (inflamación del tejido que rodea el corazón) o arritmias      (alteraciones en el ritmo cardíaco). La anquilosis, en cambio, se refiere a la rigidez o fusión de una             articulación debido a una enfermedad, lesión o procedimiento quirúrgico. 
    
    PARA ESTAR SEGURO VISITE A UN ESPECIALISTA '):-anquilosis1,!.
...
anquilosis :- opcion_a_1, opcion_a_2, opcion_a_3, opcion_a_4.
anquilosis :- opcion_a_1, opcion_a_2, opcion_a_3.
anquilosis :- opcion_a_1, opcion_a_2.
anquilosis :- opcion_a_1.
...
opcion_a_1:-pregunta('¿Tiene dolor e inflamación en la espalda?'), !. 
opcion_a_2:-pregunta('¿Siente rigidez en otras articulaciones?'), !.
opcion_a_3:-pregunta('¿Tiene síntomas generales como fatiga o malestar?'), !.
opcion_a_4:-pregunta('¿Ha tenido fiebre recientemente?'), !.
